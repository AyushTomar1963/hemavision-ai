    ...
    <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8">
      <div className="mb-8 max-w-2xl">
        ...
        <h1 className="font-serif text-4xl leading-tight text-[var(--ink)] sm:text-5xl">
          Point, pull, hold still.
        </h1>
        <p className="mt-4 text-[16px] leading-relaxed text-[var(--muted)]">
          Sit near a window. Pull your lower eyelid gently down. Fill the oval
          with the inner pink surface — not the iris, not the white of the eye.
      ...
      <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.85fr)]">
        ...
        <aside className="space-y-6">
          <div className="border border-[var(--line)] bg-[var(--surface)] px-4 py-4">
            <h2 className="font-serif text-lg">Quick tips</h2>
            <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-[var(--muted)]">
              <li>Face daylight — a window works. Skip point flashes.</li>
              <li>Pull the lower lid gently down; look up a little.</li>
              <li>Zoom until the oval is filled with pink tissue.</li>
              <li>Hold still — even a phone-shake wobble hurts the read.</li>
            </ol>
            <p className="mt-3 text-[12px] text-[var(--muted)]">
              First time?{" "}
              <a href="/how-it-works" className="underline decoration-[var(--line)]">
          ...
          <fieldset className="border border-[var(--line)] bg-[var(--surface)] px-4 py-4">
            <legend className="px-1 font-serif text-lg">Sex (WHO cutoff)</legend>
            <p className="mb-3 text-[12px] text-[var(--muted)]">
              Only used to choose the right anaemia threshold. The Hb number
